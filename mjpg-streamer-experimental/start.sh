...
./mjpg_streamer -i "./input_uvc.so -r 1280x720 -f 60" -o "./output_http.so -w ./www" -o "./output_file.so -m camrecord -f /home/ubuntu/tffs-demo/mnt/testrun -l /home/ubuntu/tffs-demo/var/run/motion"
